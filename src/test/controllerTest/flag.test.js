  ...
  it("should return a 422 status error if reason is longer than 100 characters", done => {
    chai
      ...
      .send({
        carId: 4,
        reason:
          "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Turpis massa sed elementum tempus egestas. Enim nec dui nunc mattis. Sapien eget mi proin sed libero.",
        description: "super weird reason"
      })
      .set("Authorization", userToken)
      .end((error, res) => {
        ...
        expect(res.body.message).to.deep.equal(
          "Reason should not exxceed 100 characters"
        );
        done();
      });
  });
